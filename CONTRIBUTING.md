...
Ready to contribute? Here's how to set up `cojopy` for local development.

1. Fork the `cojopy` repo on GitHub.
2. Clone your fork locally

    ```
    $ git clone git@github.com:your_name_here/cojopy.git
    ```
...
3. The pull request should work for Python 3.6, 3.7, 3.8 and 3.9. Check
   https://github.com/Jianhua-Wang/cojopy/actions
   and make sure that the tests pass for all supported Python versions.

## Tips

```
$ poetry run pytest tests/test_cojopy.py
```
